package com.itstime2gohunting.stormy.ui;
...
import com.itstime2gohunting.stormy.R;
import com.itstime2gohunting.stormy.weather.Current;
import com.itstime2gohunting.stormy.weather.Day;
import com.itstime2gohunting.stormy.weather.Forecast;
import com.itstime2gohunting.stormy.weather.Hour;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getForecast() {
        String apiKey = "c03174652c6a88fe3d21c01bcdda3c1f";
        double latitude = 38.2500;
        double longitude = -85.7667;
    ...
    private Current getCurrentDetails(String jsonData) throws JSONException{
        JSONObject forecast = new JSONObject(jsonData);
        String timezone = forecast.getString("timezone");
        Log.i(Tag,"Get forecast from" + timezone);
